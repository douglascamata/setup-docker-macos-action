...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const updateResults = yield exec_1.default.getExecOutput('brew', [
                'update',
                '--preinstall',
            ]);
            ...
            if (cacheHit === false) {
                ...
                const installResult = yield exec_1.default.getExecOutput('brew', installArgs);
                checkCommandFailure(installResult, 'Cannot install Colima and Docker client.');
                if (cacheDeps === true) {
                    const toCache = yield brewCache.cacheFolder(binTools, colimaDeps);
                    yield cache_1.default.saveCache(toCache, cacheKey);
            ...
            const startResult = yield exec_1.default.getExecOutput('colima', ['start']);
            checkCommandFailure(startResult, 'Cannot started Colima.');
            const dockerVersionResult = yield exec_1.default.getExecOutput('docker', ['version']);
            ...
            const colimaVersionResult = yield exec_1.default.getExecOutput('colima', ['version']);
